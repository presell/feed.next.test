...
import sty from "./PlasmicNavLogoOnly.module.css"; // plasmic-import: lYB7UdKosV5ydd/css
        ...
        {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
          ...
          >
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__asTd)} />
            ) : null}

            <div className={classNames(projectcss.all, sty.column__luFf9)}>
              <p.PlasmicLink
            ...
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__ze1Qd)} />
            ) : null}
          </div>
        ) : null}
      </div>
