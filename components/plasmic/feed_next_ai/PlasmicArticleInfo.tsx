...
import NavArticle1 from "../../NavArticle1"; // plasmic-import: fmB6r6QNuXzbfE/component
import BodyArticle1 from "../../BodyArticle1"; // plasmic-import: Hfcv71zWsenA5Y/component
...
import sty from "./PlasmicArticleInfo.module.css"; // plasmic-import: _r9ACswyM-IvB/css
          ...
          >
            <ph.DataCtxReader>
              {$ctx => (
                <React.Fragment>
                  <PlasmicHead
                    className={classNames("__wab_instance", sty.head__gGcb)}
                    description={(() => {
                      try {
                  ...
                  <NavArticle1
                    className={classNames(
                      "__wab_instance",
                      sty.navArticle1__gfNj8
                    )}
                  />

                  <PlasmicHead
                    className={classNames("__wab_instance", sty.head__w3Ha)}
                    description={(() => {
                      try {
